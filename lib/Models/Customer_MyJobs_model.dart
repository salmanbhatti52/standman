...
CustomerMyJobModel customerMyJobModelFromJson(String str) => CustomerMyJobModel.fromJson(json.decode(str));

String customerMyJobModelToJson(CustomerMyJobModel data) => json.encode(data.toJson());
...
class CustomerMyJobModel {
  ...
  factory CustomerMyJobModel.fromJson(Map<String, dynamic> json) => CustomerMyJobModel(
    status: json["status"],
