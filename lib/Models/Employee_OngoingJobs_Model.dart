...
EmployeeOngoingJobsModel employeeOngoingJobsModelFromJson(String str) => EmployeeOngoingJobsModel.fromJson(json.decode(str));

String employeeOngoingJobsModelToJson(EmployeeOngoingJobsModel data) => json.encode(data.toJson());
