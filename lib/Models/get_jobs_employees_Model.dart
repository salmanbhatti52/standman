...
GetJobsEmployeesModel getJobsEmployeesModelFromJson(String str) => GetJobsEmployeesModel.fromJson(json.decode(str));

String getJobsEmployeesModelToJson(GetJobsEmployeesModel data) => json.encode(data.toJson());
