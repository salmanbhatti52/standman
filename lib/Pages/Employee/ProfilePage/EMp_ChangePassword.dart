...
Future EMpChangePassword(BuildContext context, useremail, oldpassword) {
                          ...
                          child: Column(
                            children: [
                              ...
                              GestureDetector(
                                  onTap: () async {
                                    ...
                                    if (key.currentState!.validate()) {
                                      if (oldpasswordController.text.isEmpty) {
                                        toastFailedMessage(
                                            'Old Password cannot be empty', Colors.red);
                                        ...
                                        if(changeMyPasswordModel.status == "success"){
                                          Future.delayed(const Duration(seconds: 3), (){
                                            toastSuccessMessage("Changed password successfully", Colors.green);
                                            Get.back();
                                            stateSetterObject(() {
                                              isInAsyncCall = false;
                                            });
                                        ...
                                        if(changeMyPasswordModel.status != "success"){
                                          toastFailedMessage(
                                              changeMyPasswordModel.message, Colors.red);
                                          stateSetterObject(() {
                                            isInAsyncCall = false;
                                          });
                                        }
                                  ...
                                  child: mainButton("Update Password", Color(0xff2B65EC), context)),
                              // SizedBox(
                              //   height: height * 0.02,
                              // ),
                            ],
