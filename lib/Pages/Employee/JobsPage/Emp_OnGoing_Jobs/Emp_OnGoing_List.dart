...
class EmpOnGoingJobList extends StatefulWidget {
  @override
  _EmpOnGoingJobListState createState() => _EmpOnGoingJobListState();
}

class _EmpOnGoingJobListState extends State<EmpOnGoingJobList> {
...
List EmponGoingjobstList = [
  _emponGoingjobstList(
...
class _emponGoingjobstList {
  ...
  _emponGoingjobstList(this.image, this.title, this.subTitle, this.image2, this.text, this.button);
}
