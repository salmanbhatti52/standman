                              ...
                              Center(
                                ...
                                //         : null),
                                  child: CircleAvatar(
                                    ...
                                    backgroundImage: imagePath == null?
                                    AssetImage("assets/images/fade_in_image.jpeg",)
                                        : Image.file(imagePath!, height: 50, width: 50, fit: BoxFit.contain,).image,
                                  )
                              ),
                              Positioned(
                                bottom: 0,
                              ...
                              onTap: () async {
                                if(key.currentState!.validate()){
                                  if (firstNameController.text.isEmpty) {
                                    toastFailedMessage('First Name cannot be empty', Colors.red);
                                  } else if (lastNameController.text.isEmpty) {
                                    toastFailedMessage('Last Name cannot be empty', Colors.red);
                                    ...
                                    toastFailedMessage('password must be 8 digit', Colors.red);
                                  }  else if (passwordConfirmController.text.length < 8) {
                                    toastFailedMessage('Confirm password must be 8 digit', Colors.red);
